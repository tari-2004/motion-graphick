...
export default function HeroSection() {
  return (
    <section className="relative min-h-[85vh] w-full overflow-hidden bg-ink px-6 md:px-12 py-20">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(255,17,76,0.12),transparent_25%),radial-gradient(circle_at_bottom_right,_rgba(21,123,255,0.14),transparent_28%)] pointer-events-none" />
      ...
      <div className="relative z-10 mx-auto flex max-w-[1400px] flex-col gap-12 lg:gap-0 lg:flex-row lg:items-center lg:justify-between">
        ...
        >
          ...
          <h1 className="text-6xl md:text-[6.5rem] font-black uppercase tracking-[-0.05em] text-titanium leading-[0.9] max-w-[10ch]">
            Raw Motion. Refined Motion.
          </h1>
          <p className="mt-8 max-w-xl text-base md:text-lg leading-8 tracking-[0.18em] text-soft-blue/80">
        ...
        {/* <motion.div
          ...
          className="flex w-full max-w-xl flex-col gap-6 rounded-[2rem] border border-brand-blue/10 bg-white/5 p-8 shadow-[0_30px_70px_rgba(0,0,0,0.14)] backdrop-blur-xl"
        >
